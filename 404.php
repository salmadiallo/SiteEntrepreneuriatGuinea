...
<body>
                ...
                <div class="navbar-nav me-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu fade-up m-0">
                            <a href="#" class="dropdown-item ">Agroalimentaire</a>
                            <a href="#" class="dropdown-item">Mode & Artisanat</a>
                            <a href="#" class="dropdown-item">Education</a>
                            <a href="#" class="dropdown-item">Autres</a>
                        </div>
                    </div> 
                    <a href="#" class="nav-item nav-link ">Trouver votre idole</a>
    ...
    <div class="container-fluid page-header mb-5 py-5">
        <div class="container">
            <h1 class="display-3 text-white mb-3 animated slideInDown">404 Page introuvable</h1>
        </div>
    </div>
    <!-- Page Header End -->
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="#">Formation</a>
                    <a class="btn btn-link" href="#">Montage de projet</a>
