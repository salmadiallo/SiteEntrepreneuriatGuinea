...
--
-- Client :  127.0.0.1
-- Généré le :  Mar 30 Avril 2024 à 18:24
...
(8, '8700fatou1.jpg', 'Actualité de Mme Fatoumata Cissoko', 'https://www.facebook.com/fatou.t.cissoko', 1),
...
(15, '31323FatouNouvel.jpeg', 'Actualité de Mme Fatoumata Camara', 'https://www.facebook.com/profile.php?id=100047253635263', 1),
...
CREATE TABLE `message` (
  ...
  `contenu` text,
  `id_destintaire` varchar(255) DEFAULT NULL,
  `id_auteur` varchar(255) DEFAULT NULL,
...
(22, 'salut', '@COMA', '@DiSa', '2024-04-19'),
(23, 'Comment vas-tu', '@DiSa', '@COMA', '2024-04-19'),
(24, 'Je vais bien et toi ?', '@COMA', '@DiSa', '2024-04-19'),
(25, 'oui pareille et la famille ?', '@DiSa', '@COMA', '2024-04-19'),
(26, 'tout le va bien ', '@COMA', '@DiSa', '2024-04-19'),
(27, 'hee', '@DiSa', '@COMA', '2024-04-19'),
(28, 'lkjhsdlqhjhdqjghjg', '@DiSa', '@COMA', '2024-04-19'),
(29, 'lkjhsdlqhjhdqjghjg', '@DiSa', '@COMA', '2024-04-19'),
(30, 'skhds', '@DiSa', '@COMA', '2024-04-19'),
(31, 'tout le va bien ', '@COMA', '@DiSa', '2024-04-19'),
(32, 'wbHhbsqhbjbcjebkj', '@COMA', '@DiSa', '2024-04-19'),
(33, ';xbKFFLKGI', '@DiSa', '@COMA', '2024-04-19'),
(34, 'Je vais bien et toi ?', '@COMA', '@DiSa', '2024-04-19'),
(35, 'Je vais bien et toi ?', '@COMA', '@DiSa', '2024-04-19'),
(36, 'wbHhbsqhbjbcjebkj', '@COMA', '@DiSa', '2024-04-30'),
(37, 'LkdhjlshJ', '@DiSa', '@COMA', '2024-04-30'),
(38, 'LkdhjlshJ', '@DiSa', '@COMA', '2024-04-30'),
(39, 'QKSJGfkqh', '@DiSa', '@COMA', '2024-04-30'),
(40, ';HDSFKJ', '@COMA', '@DiSa', '2024-04-30');
...
(14, 'CONTE', 'MABINTY', '$2y$10$tu2D9ctqamPQQijo4Lu2U.yxz9pKaPt1MdwYufDVzlHwrokQsEbDi', 'mabinty@gmail.com', '@COMA'),
(15, 'Diallo', 'Salamata', '$2y$10$PJvTpwLeNCRchrD8YuFNueEDjgDDiZTB5yd03QKCeRZAAxi/WXYMO', 'salamata@gmail.com', '@DiSa'),
(16, 'Mara', 'Mawa', '$2y$10$JAbo67RMmX9p65Zy0L14MeLpZYGKlPawoefg8pXW07nFmqCq79CHu', 'mara@gmail.com', '@MaMa'),
(17, 'CONTE', 'MANTY', '$2y$10$csbTx45DKNUkAxgOvySjkeeHVoeG2iE6Z1doyzDGJBKraUFZQ38je', 'manty@gmail.com', '@COMA'),
(18, 'DIALLO', 'SALMA', '$2y$10$MMuZ9XXqzv3b.ojrdEsBF.uk6Ngr6qut92pIcO2HHvWqa1MrfsUly', 'salma@gmail.com', '@DISA'),
(19, 'MAMAN', 'PAPA', '$2y$10$W5Nomd9iKbfml59ZGPhFj.tdqEPcUhB3XiOi4aJy4ZB4pfHCPUWqq', 'mapa@gmail.com', '@MAPA');
...
--
ALTER TABLE `message`
  MODIFY `id_message` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
