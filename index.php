...
<head>
    <meta charset="utf-8">
    <title>Entrepreuneuriat feminin/Accueil</title>
        ...
        <div class="row align-items-center top-bar">
            <div class="col-lg-3 col-md-12 text-center text-lg-start">
                <a href="" class="navbar-brand m-0 p-0">
                    <h3 class="text-primary m-0" id="efg">Entrepreuneuriat Feminin Guinea (EFG)</h3>
                </a>
                <!-- <script>
                    var typed3 = new Typed('#efg', {
                        strings: ['Entrepreuneuriat Feminin Guinea (EFG)'],
                        typeSpeed: 0,
                        backSpeed: 4,
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white p-3 py-lg-0 px-lg-4">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav me-auto">
                    ...
                    <a href="guide_i.php" class="nav-item nav-link">Guide</a>
                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h4 class="text-white text-uppercase mb-3 animated slideInDown">L'entrépreneuriat féminin en Guinée éclaire le chemin vers l'autonomisation économique, une initiative guidée par la détermination des femmes.</h4>
                                <h2 class="display-3 text-white animated slideInDown mb-4">C'est quoi l'entrépreneuriat ?</h2>
                                <p class="fs-5 fw-medium text-white mb-7 pb-2 ">L’entrepreneuriat désigne l’action d’entreprendre,<br> de mener à bien un projet.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="owl-carousel-item position-relative" class="imgGuinee">
                ...
                <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(0, 0, 0, .4);">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                <h4 class="text-white text-uppercase mb-3 animated slideInDown">Les femmes Guinéennes au coeur de la croissance et du developpement via l'entrépreneuriat !</h4>
                                <h1 class="display-3 text-white animated slideInDown mb-4">OSEZ ENTREPRENDRE</h1>
                                <p class="fs-5 fw-medium text-white mb-4 pb-2 text-uppercase">la peur, la conscience du risque vous bloque ?
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Nombreuses sont celles qui veulent franchir le pas pour vivre de leur passion et retrouver un meilleur équilibre entre une vie privée et une vie professionnelle.</p>
                    <h4 class="text-center text-secondary">Les secteurs d'activités qui attirent <br> les femmes entrepreneures En Guinée</h4>
                    <div >
                        <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Agroalimentaire</p>
                        <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Mode & Artisanat</p>
                        ...
                        <p class="fw-medium text-primary"><i class="fa fa-check text-success me-3"></i>Services Financiers</p>
                ...
                <div class="col-lg-7 pt-4" style="min-height: 500px;">
                    <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                        ...
                        <img class="position-absolute start-0 bottom-0 img-fluid bg-white pt-2 pe-2 w-50 h-50" src="img/imgs/tailleur.png" style="object-fit: cover;" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        ...
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="#" id="com"><i class="fa fa-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        ...
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="#" id="serv"><i class="fa fa-arrow-right"></i></a>
                ...
                <div class="col-lg-4 col-md-6 service-item-top wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex align-items-center justify-content-between bg-light p-4">
                        ...
                        <a class="btn btn-square btn-outline-primary border-2 border-white flex-shrink-0" href="#" id="art"><i class="fa fa-arrow-right"></i></a>

                    </div>
                    <p>Madame Binta Diallo </p>
                        <script>
                            document.getElementById("com").onclick = ()=> {
                                swal("Attention", "Veuillez créer un compte ou vous connecter pour accéder à ce service", "warning");
                            }
    ...
    <div class="row g-0">
        <div class="col-lg-3 ">
            <div class="text-center bg-primary w-100 h-100">
                ...
                <h1 style="color: white; font-weight: 600;">Découvrez la force entrepreneuriale des femmes guinéennes, pionnières de changement et bâtisseuses d'avenirs prospères.</h1>
        ...
        <div class="col-md-12 col-lg-9">
            <div class="ms-lg-5 ps-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h3 class="text-secondary text-uppercase">Nous avons mis en place différents services pour vous !!!</h3>
                ...
                <div class="owl-carousel service-carousel position-relative wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light p-4">
                        ...
                        <a href="#" class="btn bg-white text-primary w-100 mt-2" id="con">Lire plus<i class="bi bi-arrow-right text-secondary ms-2"></i> </a>
                    </div>
                   <script>
                    ...
                    <div class="bg-light p-4">
                        ...
                        <!-- <script>
                            document.getElementById("con").onclick = ()=> alert("Veuillez vous conneccter vous accéder à ce service")
                        </script> -->
                        <h4 class="mb-3">Montage Projet</h4>
                        <p>Nous assistons aux différents besoins.</p>
                        <a href="#" class="btn bg-white text-primary w-100 mt-2" id="projet">Lire plus<i class="fa fa-arrow-right text-secondary ms-2"></i></a>
                        <script>
                            document.getElementById("projet").onclick = ()=> {
                                swal("Attention", "Veuillez créer un compte ou vous connecter pour accéder à ce service", "warning");
                            }
                        </script>
                    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a class="btn btn-link" href="#" id="formation">Formation</a>
                    <a class="btn btn-link" href="#" id="projet">Montage de projet</a>
                    <a class="btn btn-link" href="#" id="conseiller">Conseils</a>
                    <script>
                        let formation = document.getElementById("formation")
                        let projet = document.getElementById("projet")
                        let conseiller = document.getElementById("conseiller")

                        formation.onclick = function(){
                            swal("Attention", "Service non disponible pour le moment", "warning");
                        }
                        projet.onclick = function(){
                            swal("Attention", "Veuillez-vous connecter pour accéder à ce service", "warning");
                        }
                        conseiller.onclick = function(){
                            swal("Attention", "Veuillez-vous connecter pour accéder à ce service", "warning");
                        }
                    </script>
